...
public class UnifiedStructuredArrayTest {
    ...
    public void shouldConstructArrayOfGivenDirectLengths() throws NoSuchMethodException {
        ...
        final UnifiedStructuredArray<MockStructure> array =
                UnifiedStructuredArray.newInstance(MockStructure.class, 7L, 8L, 9L);
    ...
    public void shouldConstructArrayOfGivenLengthAndInitValues() throws NoSuchMethodException {
        ...
        final UnifiedStructuredArray<MockStructure> array =
                UnifiedStructuredArray.newInstance(MockStructure.class, lengths, initArgTypes, expectedIndex, expectedValue);
    ...
    public void shouldConstructArrayElementsViaElementConstructorGenerator() throws NoSuchMethodException {
        ...
        final UnifiedStructuredArray<MockStructure> array =
                UnifiedStructuredArray.newInstance(constructorAndArgsLocator, lengths);
    ...
    public void shouldIterateOverArray() throws NoSuchMethodException {
        ...
        UnifiedStructuredArray<MockStructure>.StructureIterator iter = array.iterator();
    ...
    public void shouldIterateOverArrayAndResetAgain() throws NoSuchMethodException {
        ...
        int i = 0;
        final UnifiedStructuredArray<MockStructure>.StructureIterator iter = array.iterator();
        while (iter.hasNext()) {
            final long[] cursors = iter.getCursors();
            final MockStructure mockStructure = iter.next();
            long indexSum = 0;
    ...
    public void shouldConstructCopyOfArray() throws NoSuchMethodException {
        ...
        final ConstructorAndArgsLocator<MockStructure> constructorAndArgsLocator =
                new DefaultMockConstructorAndArgsLocator();
        final UnifiedStructuredArray<MockStructure> sourceArray =
                UnifiedStructuredArray.newInstance(constructorAndArgsLocator, lengths);
        ...
        final UnifiedStructuredArray<MockStructure> newArray =
                UnifiedStructuredArray.copyInstance(sourceArray);
    ...
    public void shouldConstructCopyOfArrayRange() throws NoSuchMethodException {
        ...
        long[] counts = {14, 6, 4};
        final UnifiedStructuredArray<MockStructure> newArray =
                UnifiedStructuredArray.copyInstance(sourceArray, offsets, counts);

        final UnifiedStructuredArray<MockStructure>.StructureIterator iter = newArray.iterator();
    ...
    private void initValues(final long[] lengths, final UnifiedStructuredArray<MockStructure> array) {
        final long[] cursors = new long[lengths.length];
        final long totalElementCount = array.getTotalElementCount();
        long elementCountToCursor = 0;
