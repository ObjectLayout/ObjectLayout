 ...
 *     and can support elements of any class that provides public constructors. The elements in a SingleDimensionalStructuredArray
 ...
 *     the form of {@link SingleDimensionalStructuredArray#get}() (for {@link int} indices) or {@link SingleDimensionalStructuredArray#getL}()
 ...
 * <p>
 *     Note: At least for some JVM implementations, {@link SingleDimensionalStructuredArray#get}() access may be faster than
 *     {@link SingleDimensionalStructuredArray#getL}() access.
 *
 * @param <T> type of the element occupying each array slot.
 */
public final class SingleDimensionalStructuredArray<T> implements Iterable<T> {
     ...
     */
    public static void shallowCopy(final SingleDimensionalStructuredArray src, final long srcOffset,
                                   final SingleDimensionalStructuredArray dst, final long dstOffset,
                                   final long count) {
    ...
    public class StructureIterator implements Iterator<T> {
        ...
        /**
         * Remove operation is not supported on {@link SingleDimensionalStructuredArray}s.
         *
