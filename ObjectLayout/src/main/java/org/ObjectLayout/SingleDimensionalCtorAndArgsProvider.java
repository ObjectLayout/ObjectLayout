...
/**
 * A functional interface for providing a constructor and arguments, given a (single
 * dimensional) index. Used for providing element construction information
 * in (single dimensional) StructuredArrays.
 *
 * @param <T> type of the element occupying each array slot.
 */
public interface SingleDimensionalCtorAndArgsProvider<T> extends AbstractCtorAndArgsProvider<T> {
